    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <motion.div
              className="relative w-full max-w-4xl max-h-[90vh] bg-theme-card rounded-3xl 
                  ...
                  >
                    {quickActions.map((action, index) => (
                      <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        onClick={() => {
                          // This will be handled by the ChatDemo component
