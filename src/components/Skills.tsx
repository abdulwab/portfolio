...
const skills: Skill[] = [
  ...
  { name: 'MCP Protocol', icon: '🔗', category: 'ai', tags: ['Agent Communication', 'Standards', 'Interop'], details: 'Model Context Protocol for agent-to-agent communication', projects: 8, proficiency: 90 },
  { name: 'OpenAI Agent SDK', icon: '🤖', category: 'ai', tags: ['Assistants', 'Tools', 'Function Calling'], details: 'OpenAI framework for autonomous agents', projects: 12, proficiency: 92 },
  { name: 'A2A Protocols', icon: '💬', category: 'ai', tags: ['Agent-to-Agent', 'Communication', 'Coordination'], details: 'Advanced multi-agent coordination patterns', projects: 6, proficiency: 88 },
  { name: 'Google Agentic Framework', icon: '🏗️', category: 'ai', tags: ['Vertex AI', 'Gemini', 'Google Cloud'], details: 'Google&apos;s enterprise agent platform', projects: 5, proficiency: 82 },
  ...
  { name: 'Anthropic Claude', icon: '🔮', category: 'ai', tags: ['Constitutional AI', 'Sonnet', 'Tool Use'], details: 'Safe and helpful AI assistant with advanced tool use', projects: 14, proficiency: 90 },
  { name: 'AutoGen', icon: '🔄', category: 'ai', tags: ['Multi-Agent', 'Conversations', 'Microsoft'], details: 'Microsoft&apos;s multi-agent conversation framework', projects: 7, proficiency: 85 },
  ...
  { name: 'Semantic Kernel', icon: '🧩', category: 'ai', tags: ['Microsoft', 'Cross-platform', 'Orchestration'], details: 'Microsoft&apos;s AI orchestration framework', projects: 4, proficiency: 80 },
  ...
  { name: 'FastAPI', icon: '⚡', category: 'web', tags: ['Python', 'Async', 'Agent APIs'], details: 'High-performance Python web framework for AI agents', projects: 10, proficiency: 86 },
